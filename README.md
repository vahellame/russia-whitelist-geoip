...
Рядом лежит `geoip.dat.sha256` — только хеш, 64 символа без имени файла. По нему INCY понимает, что файл не менялся, и не качает его заново ([документация](https://docs.incy.cc/en/routing/))
